...
public class AhnentafelHTML {
    ...
    public static void main(String[] args) throws IOException,
        ...
        parser.load("/Users/frizbog/Harrah.ged");
    ...
    /**
     * Produce report on the next person in the queue of people being reported. As we process each person, we may add
     * more people to the queue.
     */
